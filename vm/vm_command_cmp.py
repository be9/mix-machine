...
def cmpa(command, context):
	M = context.mem.get(command.addr() + context.get_reg_index(command.index()))
...
cmdList.add_command(56,	-1, cmpa, 2,	"CMPA")
cmdList.add_command(63,	-1, cmpx, 2,	"CMPX")

cmdList.add_command(57,	-1, cmpi, 2,	"CMP1")
cmdList.add_command(58,	-1, cmpi, 2,	"CMP2")
cmdList.add_command(59,	-1, cmpi, 2,	"CMP3")
cmdList.add_command(60,	-1, cmpi, 2,	"CMP4")
cmdList.add_command(61,	-1, cmpi, 2,	"CMP5")
cmdList.add_command(62,	-1, cmpi, 2,	"CMP6")
